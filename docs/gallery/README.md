...
|---|---|---|
| Schwarzschild | `presets/gallery/schwarzschild.json` | `blackhole-cli --params presets/gallery/schwarzschild.json --output docs/gallery/schwarzschild.png` |
| Moderate Kerr, spin 0.5 | `presets/gallery/kerr-moderate.json` | `blackhole-cli --params presets/gallery/kerr-moderate.json --output docs/gallery/kerr-moderate.png` |
| High prograde Kerr, spin 0.99 | `presets/gallery/kerr-high-prograde.json` | `blackhole-cli --params presets/gallery/kerr-high-prograde.json --output docs/gallery/kerr-high-prograde.png` |
